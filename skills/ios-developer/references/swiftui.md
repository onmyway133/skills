...
| `cornerRadius()` | `.clipShape(.rect(cornerRadius: 12))` |
| `fontWeight(.bold)` | `.bold()` |
| `tabItem()` | `Tab("Title", systemImage: "icon") { }` |
...
**Always prefer trailing closure syntax** for better readability:
...
8. **Prefer trailing closures** for better readability
